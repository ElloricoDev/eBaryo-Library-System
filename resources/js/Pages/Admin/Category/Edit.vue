...
<template>
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="fs-3 fw-bold mb-0 bi bi-tags">Edit Category</h1>
            <Link :href="route('admin.categories.index')" class="btn btn-secondary bi bi-arrow-left"> Back to Categories</Link>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-3">
                                <label for="description" class="form-label"><i class="bi bi-card-list"></i> Description</label>
                            ...
                            <button type="submit" class="btn btn-primary" :disabled="form.processing">Update Category</button>
                        </form>
                    </div>
                </div>
            </div>
