...
<template>
  <div class="card mb-4 border-success shadow admin-update-password-card">
...
<style scoped>
.admin-update-password-card {
  border-width: 2px;
  border-radius: 1.25rem;
  transition: box-shadow 0.2s, border-color 0.2s;
}
.admin-update-password-card:focus-within, .admin-update-password-card:hover {
