...
<template>
  ...
  <div class="container py-4">
    <div class="d-flex align-items-center mb-4">
      <Link :href="route('user.profile.index')" class="btn btn-outline-success me-3">
    ...
    <form @submit.prevent="submit" enctype="multipart/form-data" class="card border-success shadow profile-edit-card p-4">
      <div class="row g-3">
        <div class="col-md-6">
      ...
      <div class="mt-4 d-flex gap-2">
        ...
        <Link :href="route('user.profile.index')" class="btn btn-outline-success">
...
.profile-edit-card:focus-within, .profile-edit-card:hover {
